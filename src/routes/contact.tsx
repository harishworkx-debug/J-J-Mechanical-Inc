...
import { CallButton, Eyebrow, WhatsAppButton } from "@/components/site/Chrome";
import { SITE } from "@/data/site";

export const Route = createFileRoute("/contact")({
  head: () => ({ meta: [
    { title: "Contact J&J Mechanical | Call 24/7" },
    { name: "description", content: "Call or WhatsApp J&J Mechanical for HVAC, plumbing and gas service in Blackstone and Southside Virginia." },
